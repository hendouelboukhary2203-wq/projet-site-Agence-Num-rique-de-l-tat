          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "1rem", flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              <Link href={'/${lang}'} style={{ display: "flex", alignItems: "center", textDecoration: "none", color: "inherit" }}>
                <Image src="https://hendouelboukhary2203-wq.github.io/projet-site-Agence-Num-rique-de-l-tat/4.jpg" alt="شعار الوكالة" width={40} height={40} style={{ objectFit: "cover", borderRadius: 6 }} />
              </Link>
